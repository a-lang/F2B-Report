...
var FR3="";
var FR4="";
for(var i=0;i<=e.F2B_10T_Attack.length-1;i++){FR1=FR1+"<tr>";for(var h=0;h<=3-1;h++){FR1=FR1+"<td>"+e.F2B_10T_Attack[i][h]+"</td>"}FR1=FR1+"</tr>"}
for(var i=0;i<=e.F2B_10T_IP.length-1;i++){FR2=FR2+"<tr>";for(var h=0;h<=3-1;h++){FR2=FR2+"<td>"+e.F2B_10T_IP[i][h]+"</td>"}FR2=FR2+"</tr>"}
